...
import static jasonxiang.com.doityourself.xj.common.utils.UIUtils.getScreenWidth;

/**
 * Created by JasonXiang on 2016/12/25.
 */
...
public class ViewPagerIndicator extends LinearLayout {
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs)
    {
        ...
        mPaint.setColor(Color.parseColor("#ffe2777c"));
    ...
    private  void scroll(int position, float offset){
        /**
         * getWidth 和 getHeight获取的高度不会超过屏幕大小
         */
        ...
        if(offset > 0 && position >= mTabVisibleCount - 2
            ...
            {
                int deltaX = (position - (mTabVisibleCount - 2)) * tabWidth
                        + (int) (tabWidth * offset);
                Log.e(TAG, "deltaX = " + deltaX);
                this.scrollTo((int) (tabWidth * offset), 0);
            } else
            // 为count为1时 的特殊处理
            {
                this.scrollTo(
