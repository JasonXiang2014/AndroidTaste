 ...
 */
public class XferModeModeView extends View {
    ...
    float textSize = getResources().getDimensionPixelSize(R.dimen.card_margin);
    ...
    public XferModeModeView(Context context) {
        super(context);
        init(null, 0);
    }

    public XferModeModeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public XferModeModeView(Context context, AttributeSet attrs, int defStyle) {
